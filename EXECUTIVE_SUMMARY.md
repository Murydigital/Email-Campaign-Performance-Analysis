...
| Revenue Per Email | **£1.21** | Corrected value (Total Revenue / Total Sent) |
...
| Rank | Campaign | Date | Segment | Subject Line Type | Revenue | Open Rate | CTR | Conv. Rate |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| **Sep‑2025** | **5** | **205,000** | **£181,000** | **16%** |
| Oct‑2025 | 4 | 203,000 | £231,400 | 20% |
| **Nov‑2025** | **3** | **189,000** | **£288,600** | **25%** |
| **Dec‑2025** | **5** | **270,000** | **££383,000** | **31%** |
| **Total** | **20** | **947,000** | **£1,142,300** | **100%** |

* **Q4 (Oct–Dec)** generates **£875,000 (77% of total revenue)** from 12 campaigns.
* **December** is the single biggest month at **£355,000**, driven by the Year-End Sale and Cyber Monday carryover.
* **May–August** contribute just **8%** of total revenue, indicating under‑utilised opportunities in the first half of the year.
...
| Segment | Campaigns | Emails Sent | Revenue | Open Rate | CTR | Revenue / Email |
| --- | --- | --- | --- | --- | --- | --- |
| **VIP Customers** | 2 | 33,000 | £84,400 | **36%** | 30% | **£2.59** |
| **Engaged Customers** | 8 | 343,000 | £334,800 | 33% | 23% | £0.98 |
| **All Subscribers** | 7 | 623,000 | £689,200 | 31% | 24% | £1.11 |
| **New Subscribers** | 2 | 80,000 | £24,100 | 30% | 20% | £0.49 |
| **Inactive** | 1 | 28,000 | £9,800 | 20% | 20% | £0.28 |

**Insights:**

* **VIP Customers** are the most valuable segment with **9.2× higher revenue per email** than Inactive subscribers and more than **2×** the overall average.
* **All Subscribers** generates the **largest share of total revenue (£689,200)** due to the high volume of peak-season sends.
* **Inactive** and **New Subscribers** segments lag significantly, indicating a need for more tailored welcome journeys or automated re‑engagement flows.
...
* **Urgency** subject lines produce the highest **click‑through rate (26%)**, suggesting strong effectiveness at driving immediate traffic.
* The **Exclusive Offer** campaign (VIP only) records the highest engagement, reinforcing that high-value segments respond best to exclusivity.
...
* **Why:** VIP Customers deliver £2.59 per email, far above the overall average (£1.21).
* **Action:** Increase VIP‑focused campaigns from **2 to 4–6 per year**, combining Exclusive Offer + Discount Offer subject lines.
* **Impact:** A lift in VIP volume at current efficiency could drive **£50,000–£80,000 additional annual revenue**.

---

### 7.2 Build Pre‑Q4 Engagement Runway

* **Why:** May–August campaigns currently account for only 8% of revenue.
...
* **Impact:** Modest performance at current benchmarks could add **10–15%** to annual revenue.

---

### 7.3 Replicate the Black Friday Sequence

* **Why:** The **Preview → Main → Follow‑up** sequence generated **£405,600 (35% of revenue)** from just 3 campaigns.
* **Action:** Build similar **Preview + Main + Follow‑up** flows for other major sales such as the Summer Sale and Halloween.

---

### 7.4 Optimise Subject Line Strategy

* **Why:** Discount Offer and Urgency consistently outperform other types.
* **Action:** Prioritise **Discount Offer** for revenue-driving sends and layer in **Urgency** wording (e.g., “Ends tonight”) to maximise last-minute clicks.

---

### 7.5 Re‑Design Win‑Back Strategy

* **Why:** The Win‑back campaign to Inactive subscribers generated only **£9,800**.
* **Action:** Test multi‑step automated journeys with stronger offers and clearer value propositions rather than single one-off sends.

---

## 8. Conclusion

The email programme is delivering strong results, with high engagement and a clear ability to monetise promotional events—especially during Q4. The largest opportunities now lie in:
...
By implementing these recommendations, the business can realistically target a **10–20% uplift** in annual email‑driven revenue purely through smarter segmentation and timing.

---

*For a detailed breakdown of methodology, queries, and calculations, see [Methodology](./documentation/project_methodology.md) and [SQL Queries](./sql/campaign_analysis_queries.sql).*
