...
**[🔗 View Live Dashboard on Tableau Public](https://www.google.com/search?q=your-tableau-link-here)**

---

## 📊 Project Overview

Portfolio project demonstrating marketing analytics using simulated Salesforce Marketing Cloud email campaign data. The analysis showcases skills in Excel, SQL, Python, and Tableau applied to email marketing optimisation across 20 campaigns (May–December 2025).
...
* 🏆 **Black Friday** was the top campaign — **£144,400 revenue**, 35% open rate, 11% conversion.
* 📅 **Q4 (Oct–Dec)** drove **77% of total revenue** — **£875,000** from 12 campaigns.
* 👑 **VIP Customers** delivered the best efficiency — 36% open rate and **£2.59 revenue per email**.
* 💰 **Discount Offer** subject lines generated the most revenue — **£529,200** (46% of total).
* ⚡ **Urgency** subject lines achieved the highest CTR — **26%**.
...
**[🔗 View Interactive Dashboard on Tableau Public](https://www.google.com/search?q=your-tableau-link-here)**
...
| **Product Announce.** | 2 | 28% | 23% | £112,800 |
...
| **Sep-2025** | 5 | **205,000** | **£181,000** | 29% | 23% |
| Oct-2025 | 4 | 203,000 | £231,400 | 30% | 24% |
| **Nov-2025** | 3 | 189,000 | **£288,600** | 35% | 25% |
| **Dec-2025** | 5 | **270,000** | **£355,000** | 32% | 23% |
...
1. **Expand VIP Programme** — VIP delivers **£2.59/email vs £1.21 average**. Increase from 2 to 6 campaigns/year (+£50K–£80K projected).
...
* **Excel:** Download `excel/email_campaigns_analysis.xlsx` and explore the pivot tables.
* **SQL:** Review queries in `sql/campaign_analysis_queries.sql`.
* **Python:** Open `python/campaign_analysis.ipynb` or the HTML export.
* **Tableau:** Visit the [live dashboard](https://www.google.com/search?q=your-tableau-link).
...
This portfolio project uses simulated data that reflect real-world Salesforce Marketing Cloud campaign structures, metrics, and reporting requirements, informed by professional experience as a Marketing Cloud Administrator.
